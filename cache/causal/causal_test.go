...
func testCache(t *testing.T, backend ml.Backend, cache cache.Cache, tests []testCase) {
...
func (c *testContext) Compute(ml.Tensor) ml.Tensor {
	return nil
}
...
func (t *testTensor) View(ctx ml.Context, offset int, shape ...int) ml.Tensor {
	...
	view := context.Zeros(ml.DTypeF32, s...).(*testTensor)
